...
var MatSelectSearchComponent = /** @class */ (function () {
    function MatSelectSearchComponent(matSelect, changeDetectorRef, _viewportRuler, matOption, liveAnnouncer, matFormField) {
        ...
        */
        ...
        this._showNoEntriesFound$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["combineLatest"])([
            ...
            this._options$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (_options) { return !!_options; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["switchMap"])(function (_options) { return _options.changes; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (options) { return options.length; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(this.getOptionsLengthOffset()))
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 2), value = _b[0], optionsLength = _b[1];
    ...
    MatSelectSearchComponent.prototype.ngOnInit = function () {
        ...
        this._options$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (options) { return !!options; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["switchMap"])(function (options) { return options.changes; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._onDestroy)).subscribe(function () {
    ...
    MatSelectSearchComponent.prototype.registerOnChange = function (fn) {
        var _this = this;
        this._formControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (value) { return value !== _this._lastExternalInputValue; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () { return _this._lastExternalInputValue = undefined; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._onDestroy)).subscribe(fn);
    };
    ...
    MatSelectSearchComponent.prototype.initMultiSelectedValues = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["combineLatest"])([
            ...
            this._options$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(function (options) { return !!options; }))
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this._onDestroy)).subscribe(function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 2), value = _b[0], options = _b[1];
...
//# sourceMappingURL=default~Portal-Report-report-module~Portal-Workmanager-workmanager-module-es5.js.map