...
let AreamasterComponent = class AreamasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
        this.lists = {};
    ...
    GetAreaMaster() {
        this.common.GetMethod('master/getmaster?master=areamaster').then((res) => {
            if (res.status == 1) {
                this.lists.Arealist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
    CreateAreaMaster() {
    ...
    DeleteConfirmation(ev) {
        let dailog = this.common.dialog.open(_Dailogbox_confirmbox_confirmbox_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmboxComponent"], { data: { status: true, Message: "Are you sure you want to delete this record?" } });
...
AreamasterComponent.ctorParameters = () => [
...
let ComplainmasterComponent = class ComplainmasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
    ...
    GetComplainMaster() {
        this.common.GetMethod('master/getmaster?master=complaintmaster').then((res) => {
            if (res.status == 1) {
                this.lists.complist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
...
ComplainmasterComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
];
...
let KycmasterComponent = class KycmasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
    ...
    GetKYCMaster() {
        this.common.GetMethod('master/getmaster?master=kyctype').then((res) => {
            if (res.status == 1) {
                this.lists.kyclist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
    resetKycform() {
...
KycmasterComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
];
...
let MastermanagerComponent = class MastermanagerComponent {
    ...
    AddBranch() {
        this.common.PostMethod("AddBranch", { name: this.lists.name, address: this.lists.address, userid: localStorage.getItem("UserId"), usertype: localStorage.getItem("UserType") }).then((res) => {
            if (res.Status == 1) {
                this.common.ToastMessage("Success", res.Message);
                this.GetBranchList();
                this.lists.name = "";
    ...
    GetBranchList() {
        ...
        this.common.GetMethod("GetBranchlist?userid=" + userid).then((res) => {
            this.lists.branchlist = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](res.Data);
            this.lists.branchlist.paginator = this.paginator;
            this.lists.branchlist.sort = this.sort;
        });
    }
    ...
    GetCitylist() {
        this.common.GetMethod('GetCitites').then((res) => {
            this.lists.Citylist = res.Data;
        }).catch();
    }
};
MastermanagerComponent.ctorParameters = () => [
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
...
let ServicemasterComponent = class ServicemasterComponent {
    constructor() {
        this.hide = true;
        this.lists = {};
        this.InitFun();
...
let StatusmasterComponent = class StatusmasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
    ...
    GetStatusMaster() {
        this.common.GetMethod('master/getmaster?master=statustype').then((res) => {
            if (res.status == 1) {
                this.lists.statuslist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
    resetStatusMaster() {
...
StatusmasterComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
];
...
let SubscriptionmasterComponent = class SubscriptionmasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
    ...
    GetSubscriptionMaster() {
        this.common.GetMethod('master/getmaster?master=subscriptionmaster').then((res) => {
            if (res.status == 1) {
                this.lists.sublist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
...
SubscriptionmasterComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
];
...
let TaxmasterComponent = class TaxmasterComponent {
    ...
    GetTaxMaster() {
        this.common.GetMethod('master/getmaster?master=taxmaster').then((res) => {
            if (res.status == 1) {
                this.lists.taxlist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
    resetTaxMaster() {
...
let UserrolemasterComponent = class UserrolemasterComponent {
    constructor(fb, common, dialog) {
        this.fb = fb;
        this.common = common;
        this.dialog = dialog;
    ...
    GetRoleMaster() {
        this.common.GetMethod('master/getmaster?master=role').then((res) => {
            if (res.status == 1) {
                this.lists.rolelist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
            }
        });
    }
    CreateUserRole() {
...
UserrolemasterComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }
];
...
//# sourceMappingURL=Portal-Master-master-module-es2015.js.map