...
var ForgotComponent = /** @class */ (function () {
    function ForgotComponent(fb, router, common) {
        this.fb = fb;
        this.router = router;
        this.common = common;
        this.lists = {};
    ...
    ForgotComponent.prototype.onSubmit = function () {
        ...
        this.common.PostMethod("Checkuser", { mobile: this.form.value.mobile }).then(function (result) {
            if (result.Status == 1) {
                _this.common.PostMethod("SendOTP", { Mobile: _this.form.value.mobile, OTP: _this.lists.Randomnumber }).then(function (res) {
                    var dailog = _this.common.dialog.open(_Portal_Dailogbox_otp_otp_component__WEBPACK_IMPORTED_MODULE_5__["OtpComponent"], {});
                    dailog.afterClosed().subscribe(function (data) {
                        if (_this.lists.Randomnumber == data) {
                            _this.common.ToastMessage("Success", "Please Enter New Password Successfully");
                            var passChnage = _this.common.dialog.open(_Portal_Dailogbox_changepassword_changepassword_component__WEBPACK_IMPORTED_MODULE_6__["ChangepasswordComponent"], {});
                            passChnage.afterClosed().subscribe(function (result) {
                                if (result.Status) {
                                    _this.ChangePassword(result.Password);
                                }
                                else {
                                    _this.common.ToastMessage("Fail", "User Cancel Password Change");
                                }
                            });
                        }
                        else {
                            _this.common.ToastMessage("Fail", "OTP not match please try again.");
                        }
                    });
                });
            }
            else {
                _this.common.ToastMessage("Fail", "Invalid User Please Contact Administrator");
            }
        });
    };
    ForgotComponent.prototype.ChangePassword = function (Password) {
        var _this = this;
        this.common.PostMethod("ForgotPassword", { mobile: this.form.value.mobile, password: Password }).then(function (res) {
            if (res.Status == 1) {
    ...
    ForgotComponent.prototype.gotologin = function () {
...
var LockscreenComponent = /** @class */ (function () {
    function LockscreenComponent(fb, router, route, common) {
        this.fb = fb;
        this.router = router;
        this.route = route;
        this.common = common;
    ...
    LockscreenComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (res) {
            console.log(res);
            _this.lists.LastUrl = res.Url;
            _this.lists.LastUrl = _this.lists.LastUrl.replace("http://localhost:4200", "");
            _this.lists.LastUrl = _this.lists.LastUrl.replace("https://easybillpay.co.in", "");
        });
    };
    LockscreenComponent.prototype.onSubmit = function () {
        var pass = localStorage.getItem("Typepography");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, router, common) {
        this.fb = fb;
        this.router = router;
        this.common = common;
        this.hide = true;
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.common.PostMethod("auth/signin", data).then(function (res) {
            if (res.status == 1) {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(_formBuilder, common) {
    ...
    Object.defineProperty(RegisterComponent.prototype, "firtsForm", {
        get: function () {
    ...
    Object.defineProperty(RegisterComponent.prototype, "secondForm", {
        get: function () {
    ...
    RegisterComponent.prototype.AddressCopy = function (e) {
        if (e.checked) {
    ...
    RegisterComponent.prototype.GetSubscriptionMaster = function () {
        var _this = this;
    ...
    RegisterComponent.prototype.GetStates = function () {
        var _this = this;
    ...
    RegisterComponent.prototype.GetCityCors = function () {
        var _this = this;
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.common.PostMethod("auth/signup", data).then(function (res) {
            if (res.status == 1) {
                _this.common.ToastMessage("Success", res.message);
            }
        }).catch(function (y) {
