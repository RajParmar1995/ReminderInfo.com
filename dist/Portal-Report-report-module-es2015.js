...
let AmazonreportComponent = class AmazonreportComponent {
    constructor(common) {
        this.common = common;
        this.hide = true;
        this.lists = {};
    ...
    ViewReport() {
        ...
        this.common.PostMethod('BillReport', this.lists).then((res) => {
...
AmazonreportComponent.ctorParameters = () => [
...
let BilldepositreportComponent = class BilldepositreportComponent {
    constructor(common) {
        this.common = common;
        this.hide = true;
        this.lists = {};
...
BilldepositreportComponent.ctorParameters = () => [
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_2__["CommonService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"], { static: true }),
...
let BillreversalComponent = class BillreversalComponent {
    constructor(common) {
        this.common = common;
        this.hide = true;
        this.lists = {};
    ...
    GetDuplicateBill() {
        let from = moment__WEBPACK_IMPORTED_MODULE_2__(this.lists.from).format("YYYY-MM-DD");
        let to = moment__WEBPACK_IMPORTED_MODULE_2__(this.lists.to).format("YYYY-MM-DD");
        this.common.PostMethod("FindSameBill", { from: from, to: to }).then((res) => {
            this.lists.duplicate = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data);
            this.lists.duplicate.paginator = this.paginator;
            this.lists.duplicate.sort = this.sort;
        });
    }
    SearchBill() {
        this.common.PostMethod("FindBill", { kno: this.lists.kno, depositdate: this.lists.depositedate }).then((res) => {
            this.lists.forcelist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data);
        });
    }
    BillReverse(ev) {
        this.common.ConfirmMessage("Confirm Do you want to reverse this bill?", (result) => {
            if (result) {
                console.log(ev);
                ev.adminid = localStorage.getItem("UserId");
                this.common.PostMethod("BillReverse", ev).then((res) => {
                    if (res.Status == 1) {
    ...
    SearchReceipt() {
        this.common.PostMethod("SearchReceipt", { search: this.lists.forcesearch }).then((res) => {
            console.log(res.Data);
            this.lists.forcelist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data);
        });
    }
};
BillreversalComponent.ctorParameters = () => [
...
let CollectionComponent = class CollectionComponent {
    ...
    GetDepositcollection() {
        ...
        let from = moment__WEBPACK_IMPORTED_MODULE_4__(this.lists.fromdate).format("YYYY-MM-DD");
        let to = moment__WEBPACK_IMPORTED_MODULE_4__(this.lists.fromdate).format("YYYY-MM-DD");
        let agentid = 0;
        if (this.lists.agentid) {
            agentid = this.lists.agentid;
        }
        this.common.GetMethod("GetDailyDeposit?id=" + id + "&from=" + from + "&to=" + to + "&agentid=" + agentid).then((res) => {
            this.lists.Depositlist = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](res.Data || []);
            res.Data.forEach(element => {
    ...
    CashDeposit() {
        ...
        this.common.PostMethod("DailyDeposit", this.collectionform.value).then((res) => {
            if (res.Status == 1) {
                this.common.ToastMessage("Success", res.Message);
...
let CreditreportComponent = class CreditreportComponent {
    ...
    GetMyCreditHistory() {
        ...
        let from = moment__WEBPACK_IMPORTED_MODULE_3__(this.lists.from).format("YYYY-MM-DD");
        let to = moment__WEBPACK_IMPORTED_MODULE_3__(this.lists.to).format("YYYY-MM-DD");
        if (localStorage.getItem("UserType") == "Super Admin") {
            UserId = 0;
        }
        if (this.lists.agentid) {
        ...
        this.common.GetMethod('UserCreditHistory?Id=' + UserId + "&from=" + from + "&to=" + to).then((res) => {
            this.lists.Creditlist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data || []);
            res.Data.forEach(element => {
                this.lists.TotalAmount = this.lists.TotalAmount + parseInt(element.amount);
            });
            this.lists.Creditlist.paginator = this.paginator;
...
let DueComponent = class DueComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PayuComponent = class PayuComponent {
    constructor(common) {
        this.common = common;
        this.hide = true;
        this.lists = {};
    ...
    ViewReport() {
        this.lists.from = moment__WEBPACK_IMPORTED_MODULE_3__(this.lists.from).format("YYYY-MM-DD");
        this.lists.to = moment__WEBPACK_IMPORTED_MODULE_3__(this.lists.to).format("YYYY-MM-DD");
        this.common.PostMethod('GetPayuReport', this.lists).then((res) => {
            res.Data.forEach(element => {
...
/* harmony import */ var ngx_mat_select_search__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ngx-mat-select-search */ "./node_modules/ngx-mat-select-search/fesm2015/ngx-mat-select-search.js");
...
let ReversedComponent = class ReversedComponent {
    constructor(common) {
        this.common = common;
        this.hide = true;
        this.lists = {};
    ...
    ViewReport() {
        ...
        this.common.PostMethod('GetReversedBills', this.lists).then((res) => {
            this.report = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data || []);
            console.log(this.report);
            this.report.paginator = this.paginator;
            this.report.sort = this.sort;
...
ReversedComponent.ctorParameters = () => [
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_2__["CommonService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"], { static: true }),
...
let UsercollectionComponent = class UsercollectionComponent {
    constructor(comman) {
        this.comman = comman;
        this.hide = true;
        this.lists = {};
    ...
    ViewReport() {
        ...
        this.comman.PostMethod('UserWiseBillReport', this.lists).then((res) => {
    ...
    GetUserList() {
        if (localStorage.getItem("UserType") == "Super Admin" || localStorage.getItem("UserType") == "Manager") {
            this.comman.GetMethod("GetUserInfo").then((res) => {
                this.lists.Userlist = res.Data;
                this.lists.Userlist.forEach(element => {
                    element.userinfo = element.name + "-" + element.Branchname;
                });
            ...
            this.comman.GetMethod("GetUserInfo?userid=" + localStorage.getItem("UserId")).then((res) => {
                this.lists.Userlist = res.Data;
                this.lists.Userlist.forEach(element => {
                    element.userinfo = element.name + "-" + element.Branchname;
                });
    ...
    GetAdminList() {
        this.comman.PostMethod("GetfilterData", { file: "users", name: "usertype", value: "Admin" }).then((res) => {
            this.lists.Adminlist = res.Data;
        });
    }
    printDiv() {
...
UsercollectionComponent.ctorParameters = () => [
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"] }
];
...
let UserworkComponent = class UserworkComponent {
    constructor(comman) {
        this.comman = comman;
        this.hide = true;
        this.lists = {};
    ...
    GetDepositorlist() {
        this.comman.PostMethod("GetfilterData", { file: "users", name: "usertype", value: "Depositor" }).then((res) => {
    ...
    ViewReport() {
        ...
        this.comman.PostMethod('GetAssingBill', this.lists).then((res) => {
            this.report = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.Data);
            this.report.paginator = this.paginator;
            this.report.sort = this.sort;
...
UserworkComponent.ctorParameters = () => [
    { type: _Service_common_service__WEBPACK_IMPORTED_MODULE_2__["CommonService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"], { static: true }),
...
//# sourceMappingURL=Portal-Report-report-module-es2015.js.map