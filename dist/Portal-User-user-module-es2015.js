...
const password = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].maxLength(30), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].pattern('^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$')]));
const confirmPassword = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]('', ng2_validation__WEBPACK_IMPORTED_MODULE_4__["CustomValidators"].equalTo(password));
...
let CreateuserComponent = class CreateuserComponent {
    ...
    CreateUser() {
        ...
        this.common.PostMethod("user/addnewuser", submitdata).then((res) => {
            if (res.status == 1) {
    ...
    // }
    GetDocList() {
        this.common.GetMethod("GetDatatable?Name=kycdoc").then((res) => {
...
let UserlistComponent = class UserlistComponent {
    ...
    GetUserList() {
        this.common.PostMethod("user/getuserlist", { where: {}, order: [['id', 'desc']], limit: 100,
            ...
            this.newUserlist = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](res.data);
        });
    }
    UserProfileEdit(ev) {
    }
    UserAllDetail(ev) {
        let dailog = this.common.dialog.open(_Dailogbox_userdetail_userdetail_component__WEBPACK_IMPORTED_MODULE_4__["UserdetailComponent"], { data: { status: true, ev } });
...
//# sourceMappingURL=Portal-User-user-module-es2015.js.map